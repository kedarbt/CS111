...
#
# output: lab2b_[1-5].png (as specified in the instructions)
...
set title "Thoughput vs Threads for mutex and spin-lock"
set xlabel "Threads"
set logscale x 2
set xrange [0.75:]
...
set title "Timing Mutex Waits and Time"
set xlabel "Threads"
set logscale x 2
set xrange [0.75:]
set ylabel "Time"
...
set title "Sublist thoughput vs Threads for spin-lock"
set xlabel "Threads"
set logscale x 2
set xrange [0.75:]
set ylabel "Throughput"
...
# grep out only successful runs with yield option
plot \
